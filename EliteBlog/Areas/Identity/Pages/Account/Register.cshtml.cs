...
namespace EliteBlog.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var fileExt = System.IO.Path.GetExtension(Input.Photo.FileName).Substring(1);
                ...
                var path = Path.Combine(this._webHostEnvironment.WebRootPath, "images/uploads", Input.Photo.FileName);
